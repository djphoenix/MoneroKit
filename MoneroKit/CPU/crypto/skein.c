...
static HashReturn  Skein_256_Init  (Skein_256_Ctxt_t *ctx, size_t hashBitLen);
#endif
static HashReturn  Skein_512_Init  (Skein_512_Ctxt_t *ctx, size_t hashBitLen);
static HashReturn  Skein1024_Init  (Skein1024_Ctxt_t *ctx, size_t hashBitLen);

static HashReturn  Skein_256_Update(Skein_256_Ctxt_t *ctx, const u08b_t *msg, size_t msgByteCnt);
static HashReturn  Skein_512_Update(Skein_512_Ctxt_t *ctx, const u08b_t *msg, size_t msgByteCnt);
static HashReturn  Skein1024_Update(Skein1024_Ctxt_t *ctx, const u08b_t *msg, size_t msgByteCnt);

static HashReturn  Skein_256_Final (Skein_256_Ctxt_t *ctx, u08b_t * hashVal);
static HashReturn  Skein_512_Final (Skein_512_Ctxt_t *ctx, u08b_t * hashVal);
static HashReturn  Skein1024_Final (Skein1024_Ctxt_t *ctx, u08b_t * hashVal);
...
static HashReturn Skein_256_InitExt(Skein_256_Ctxt_t *ctx,size_t hashBitLen,u64b_t treeInfo, const u08b_t *key, size_t keyBytes)
    {
    union
        {
        u08b_t  b[SKEIN_256_STATE_BYTES];
